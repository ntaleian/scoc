...
$(function(){
  ...
  new Morris.Bar({
    ...
    barColors: ['#4029a7', '#128c80','#f3000b'],
    gridTextSize: 11,
    hideHover: 'auto',
    resize: true
  });
  ...
  new Morris.Line({
    ...
    ykeys: ['a', 'b', 'c'],
    labels: ['Series A', 'Series B', 'Series C'],
    lineColors: ['#128c80', '#4029a7', '#fc9208'],
    lineWidth: 1,
    ymax: 'auto 100',
    gridTextSize: 11,
    hideHover: 'auto',
  ...
  new Morris.Donut({
    ...
    colors: ['#128c80','#4029a7','#fc9208','#f3000b'],
    resize: true
  });
