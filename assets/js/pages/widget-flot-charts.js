...
var newCust = [[0, 2], [1, 3], [2,6], [3, 5], [4, 7], [5, 8], [6, 10]];
  ...
  var plot = $.plot($('#flotLine1'),[
   ...
   update_plot5();
	...
	/**************** PIE CHART *******************/
   var piedata = [
      { label: "Series 1", data: [[1,10]], color: '#4029a7'},
      { label: "Series 2", data: [[1,30]], color: '#353b43'},
      { label: "Series 3", data: [[1,90]], color: '#128c80'},
      { label: "Series 4", data: [[1,70]], color: '#fc9208'},
      { label: "Series 5", data: [[1,80]], color: '#f3000b'}
	 ];
