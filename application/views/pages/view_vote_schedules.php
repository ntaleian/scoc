			...
			<div class="col-12">
				<div class="box">
					<div class="box-header with-border bg-light">
					  <h4 class="box-title">View Uploaded Vote Schedules</h4>
							...
							<div class="row">
								...
								<table id="example" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
									...
									<tbody>
										...
										<tr>
										    <td>
										        <?php if($exp == $row['TotalSum'] && $row['status'] == '1'){ ?>
										        <input type="hidden" id="exp" value="<?php echo $exp; ?>"/>
										        <input type="hidden" id="payrolldate" value="<?php echo $row['payrolldate']; ?>"/>
										        <input type="hidden" id="vote" value="<?php echo $row['vote']; ?>"/>
										        
												<button type="button" id="sa-params" class="btn btn-icon-circle btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="Reconcile Schedule"><i class="ti-check-box" aria-hidden="true"></i></button>
												<?php } ?>
