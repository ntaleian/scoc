			...
			<div class="col-12">
				<div class="box">
					<div class="box-header with-border bg-light">
					  <h4 class="box-title">Upload Expectation File</h4>
				...
				<form class="form" method="post" action="" enctype="multipart/form-data" id="exp_form">
							  ...
							  <div class="row">
								...
								<div class="col-md-3 col-12">
								  <div class="form-group">
									...
									<select class="form-control select2" style="width: 100%;" name="month" id="month" required="">
							...
							<div class="row">
								...
								<div class="col-md-6 col-12">
									<div class="form-group">
										...
										<div class="controls">
											<input type="file" name="uplfile" id="uplfile" class="form-control" required> </div>
					...
					<div class="box-footer">
					  <button type="submit" name="submit" class="btn btn-success" id='import'>Submit</button>
					</div>
					<!-- /.box-footer-->
